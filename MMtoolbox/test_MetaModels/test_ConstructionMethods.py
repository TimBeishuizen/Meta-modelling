...
class test_side_functions(TestCase):
    ...
    def test_compute_means(self):
        ...
        np.testing.assert_array_equal(CM.compute_means(self.__database_1), means_1)

        # Database 2
        means_2 = np.mat([2.0/3, 1.3/3, 3.8/3])
        np.testing.assert_array_equal(CM.compute_means(self.__database_2), means_2)
    ...
    def test_compute_variances(self):
        ...
        # Database 1
        means_1 = CM.compute_means(self.__database_1)
        ...
        np.testing.assert_array_equal(CM.compute_variances(self.__database_1), variances_1)

        # Database 2
        means_2 = CM.compute_means(self.__database_2)
        ...
        np.testing.assert_array_equal(CM.compute_variances(self.__database_2), variances_2)
    ...
    def test_compute_intervals(self):
        ...
        np.testing.assert_array_equal(CM.compute_intervals(self.__database_1), intervals_1)
        ...
        print(intervals_2)
        print(CM.compute_intervals(self.__database_2))

        np.testing.assert_array_equal(CM.compute_intervals(self.__database_2), intervals_2)
    ...
    def test_compute_norm(self):
        ...
        self.assertAlmostEqual(CM.compute_norm(self.__matrix_1), norm_1, delta=0.0001)

        # Norm 2
        norm_2 = 12.6164

        self.assertAlmostEqual(CM.compute_norm(self.__database_1), norm_2, delta=0.0001)
    ...
    def test_sing_val_decomp(self):
        ...
        dic_1 = CM.compute_sing_val_decomp(self.__database_1)
        u_r_1 = dic_1.get('U')
        s_r_1 = dic_1.get('s')
        v_r_1 = dic_1.get('V')
    ...
    def test_update_orth_basis(self):
        ...
        np.testing.assert_array_almost_equal(CM.update_orth_basis(orth_mat_1, self.__database_1[:, 2], 3),
        ...
        print(CM.update_orth_basis(orth_mat_2, self.__database_2[:, 2], 3))

        np.testing.assert_array_almost_equal(CM.update_orth_basis(orth_mat_2, self.__database_2[:, 2], 3),
    ...
    def test_update_cov(self):
        ...
        np.testing.assert_array_almost_equal(CM.update_cov(cov_1, updated_orth_mat_1, 3), upd_cov_1, decimal=3)
        ...
        np.testing.assert_array_almost_equal(CM.update_cov(cov_2, updated_orth_mat_2, 3), upd_cov_2, decimal=3)
    ...
    def test_SIMPLS(self):
        ...
        np.testing.assert_array_almost_equal(CM.SIMPLS(self.__database_1, self.__output_database_1, 2),
    ...
    def test_center_database(self):
        ...
        np.testing.assert_array_equal(CM.center_database(self.__database_1), cent_data_1)
    ...
    def test_PLSR(self):
        ...
        # database 1
        print(CM.PLSR(self.__database_1, self.__output_database_1, 2))