...
def construct_meta_model(input_data, output_data, meta_model_specifications):
    """ The construction of the meta-models. This uses the input and output data base to create a way to use the
    meta-models.
    ...
    :param meta_model_specifications: All specifications for the meta-models, being a list with the following possible
     specifications:
        ...
        - input: type of input modifier. Either 'Basic', 'Polynomial' or 'Modified', by default 'basic'. If modified,
                the next entry should give the type of modifications: 'log', 'sqt', 'root', 'inv', 'exp', 'sin', 'cos',
                'tan'.
...
def construct_DLU_meta_model(input_data, output_data):
    """
...
def PLSR(input_data, output_data, n_comp):
    ...
    :return: A meta-model created by PLSR
    """
...
def SIMPLS(input_data, output_data, n_comp):
    ...
    output_loadings = np.mat(np.zeros((output_size, n_comp)))
    ...
    for i in range(n_comp):
        ...
        output_loadings[:, i] = eig_val_s * np.transpose(eig_vec_v) / norm_scores
    ...
    print('input_loadings')
    print(input_loadings)
    print('output_loadings')
    print(input_loadings)
